...
function MessageCard ({time,images,text,left,visible}){
    // eslint-disable-next-line react/prop-types
    ...
    return (
        <div className={left ? `${styles.container} ${styles.container_left}` : styles.container}>
            <img src="https://miro.medium.com/v2/resize:fit:1400/0*0fClPmIScV5pTLoE.jpg" className={visible ? (left ? `${styles.image_icon} ${styles.image_icon_left}`: styles.image_icon) : (left ? `${styles.image_icon} ${styles.image_icon_left} ${styles.image_icon_invisible}`:` ${styles.image_icon} ${styles.image_icon_invisible}`)} alt=""/>
